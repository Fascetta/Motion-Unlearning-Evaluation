...
def arg_parse(is_train=False):
    ...
    parser.add_argument(
        "--name",
        type=str,
        default="t2m_denoiser_vpred_vaegelu",
        help="Name of this trial",
    )
    parser.add_argument(
        "--vae_name", type=str, default="t2m_vae_gelu", help="Name of the vae model."
    )
    ...
    parser.add_argument(
        "--unit_length", type=int, default=4, help="Downscale ratio of VAE"
    )
    parser.add_argument(
    ...
    ## optimization
    parser.add_argument(
        "--max_epoch", default=500, type=int, help="number of total epochs to run"
    )
    parser.add_argument(
        "--warm_up_iter",
        default=2000,
    ...
    parser.add_argument(
        "--latent_dim", type=int, default=256, help="embedding dimension"
    )
    parser.add_argument("--n_heads", type=int, default=8, help="Number of heads")
    parser.add_argument("--n_layers", type=int, default=5, help="num of layers")
    parser.add_argument("--kernel_size", type=int, default=3, help="kernel size")
    parser.add_argument(
        "--ff_dim", type=int, default=1024, help="feedforward dimension"
    )
    parser.add_argument(
        "--norm",
        type=str,
    ...
    parser.add_argument(
        "--save_latest", default=500, type=int, help="iter save latest model frequency"
    )
    parser.add_argument(
        "--eval_every_e", default=10, type=int, help="save eval results every n epoch"
    )
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="net_best_fid.tar",
        help="checkpoint file name to be loaded",
    )
